...
| <img src="images/seed-dashboard/step6.png" alt="drawing" width="50%"/> | **Device Status** - This section indicates the current status of your device. There are three statuses: blocked and enabled. Hover over the tooltip for explanations of these statuses. |
