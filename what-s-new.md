...
| Date  | Article | Change |
| ------------- |:-------------:|:-------------|
| 16 August 2022 | - [Offboard macOS device from SEED](https://docs.developer.tech.gov.sg/docs/security-suite-for-engineering-endpoint-devices/offboard-device/mac-os?id=step-4-remove-microsoft-defender-for-endpoint) <br> - [Offboard Windows device from SEED](https://docs.developer.tech.gov.sg/docs/security-suite-for-engineering-endpoint-devices/offboard-device/windows?id=step-4-remove-microsoft-defender-for-endpoint) | Now users can download the offboarding script and execute it to remove Microsoft Defender for Endpoint. |
