...
[Phase A: Offboard device from SEED components](#phase-a-offboard-device-from-seed-components)

[Phase B: Submit Intune Device ID](#phase-b-submit-intune-device-id)
