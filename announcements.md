...
| Date  | Announcement |
| ------------- |:-------------:|
| 22 November 2022 | We will be enforcing a new device clean-up rule for SEED users whose TechPass ID belongs to the TechPass AD. For more information, see [MDM certificate and device clean-up policy](device-clean-up-policy). |
