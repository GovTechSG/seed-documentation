...
| Date  | Announcement |
| ------------- |:-------------:|
| 21 November 2022 | We will be enforcing a new device clean-up rule for SEED users whose TechPass ID belongs to the TechPass AD. For more information, see [MDM certificate and device cleanup policy](device-cleanup-policy). |
