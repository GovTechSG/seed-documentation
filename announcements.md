...
| Date  | Announcement |
| ------------- |:-------------:|
| 18 August 2022 | Apple has released security updates to address two zero-day
vulnerabilities that affect its operating systems. Successful exploitation
allows the attacker to perform arbitrary code execution on vulnerable
