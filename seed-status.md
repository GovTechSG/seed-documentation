...
| Date | 13 June 2023 |
| ------------- |:-------------|
| Issue summary| We will be performing scheduled maintenance of the SEED servers. <br><br>**Start time** : 14 June 2023, 22:00 SGT<br>**End time**&nbsp;&nbsp;&nbsp;: 15 June 2023, 23:59 SGT<br><br>**Impact**<br>- Users may experience service disruptions on their GMDs.<br>After deployement, keep your GMDs connected to the Internet, for at least 15mins, for the synchronization to be completed before accessing GCC 2.0 or other SGTS services.<br>- If you still have issues accessing the applications after 30mins, please create an [incident support request](https://go.gov.sg/seed-techpass-support).|
